  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Box className={classes.headerNavigation} display="flex" flexDirection="row-reverse" p={1} m={1} bgcolor="background.paper">
          <Box p={1}>
            <Link>Sign in</Link>
          </Box>
          <Box p={1}>
        ...
        <Box className={classes.mainNavigation} display="flex">
          <ul>
            <li>
              <Link href={'/'} style={{'textDecoration': 'none', 'color': `rgba(3,27,78,.7)`}}>Virtual Machine Products</Link>
            </li>
            <li><Link className={classes.menuTitle}>Products</Link></li>
            <li><Link className={classes.menuTitle}>Partners</Link></li>
            <li><Link className={classes.menuTitle}>Pricing</Link></li>
          </ul>
        </Box>
        ...
        <main className={classes.mainHeaderContent} style={{'backgroundImage': `url(${backgroundLandingImage})`}}>
          <Grid container spacing={1} className={classes.mainContent}>    
            <Grid item xs={12} md={6}>
              ...
              <p className={classes.welcomeParagraph}>We make it simple to launch in the cloud and scale up as you grow – with an intuitive control panel, predictable pricing, team accounts, and more.</p>
            </Grid>
            <Grid item xs={12} md={6}>
